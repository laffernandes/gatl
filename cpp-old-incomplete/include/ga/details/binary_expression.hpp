_GA_DECLARE_ARGUMENT_STORAGE_FOR_EXPRESSION(first)
_GA_DECLARE_ARGUMENT_STORAGE_FOR_EXPRESSION(second)
...
private:
	...
	typedef typename common_type<typename first_argument_type::coefficient_type, typename second_argument_type::coefficient_type>::type coefficient_type;

public:

	typedef Composition composition;

	typedef multivector<coefficient_type, typename if_<is_compile_time<composition>, composition, binary_expression>::type> lazy_type;
