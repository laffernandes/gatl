_GA_DECLARE_ARGUMENT_STORAGE_FOR_EXPRESSION(single)
...
public:
	...
	typedef multivector<typename single_argument_type::coefficient_type, typename if_<is_compile_time<composition>, composition, unary_expression>::type> lazy_type;
