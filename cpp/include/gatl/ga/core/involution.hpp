...
namespace ga {
    ...
    constexpr decltype(auto) involute(clifford_expression<CoefficientType, Expression> const &arg) noexcept {
    ...
    constexpr decltype(auto) involute(Type const &arg) noexcept {
        return involute(scalar(arg));
    }
