...
namespace ga {
    ...
    namespace detail {
        ...
        // The list of simplification rules used by the implementation of _addition<LeftExpression, RightExpression> with component<...>.
        template<typename LeftBasisBlade, typename RightBasisBlade>
        using _addition_components_rules_t = rules<
            _addition_components_rule_zero,
            std::conditional_t<
                lt_v<LeftBasisBlade, RightBasisBlade>,
                _addition_components_rule_merge_less_than,
                std::conditional_t<
                    lt_v<RightBasisBlade, LeftBasisBlade>,
        ...
        struct _addition<component<LeftCoefficient, LeftBasisBlade>, component<RightCoefficient, RightBasisBlade> > :
            apply_rule_for_t<
                _addition_components_rules_t<LeftBasisBlade, RightBasisBlade>,
