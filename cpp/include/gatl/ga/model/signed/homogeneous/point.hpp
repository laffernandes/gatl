...
namespace ga {
    ...
    constexpr decltype(auto) point(homogeneous_metric_space<D> const &mtr, Types &&... coords) GA_NOEXCEPT {
    ...
    constexpr decltype(auto) point(homogeneous_metric_space<D> const &mtr, IteratorType begin, IteratorType end) GA_NOEXCEPT {
...
#endif // __GA_MODEL_SIGNED_HOMOGENEOUS_POINT_HPP__
