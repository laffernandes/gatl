...
namespace ga {
    ...
    constexpr decltype(auto) euclidean_vector(homogeneous_metric_space<D> const &mtr, Types &&... coords) noexcept {
    ...
    constexpr decltype(auto) euclidean_vector(homogeneous_metric_space<D> const &mtr, IteratorType begin, IteratorType end) noexcept {
