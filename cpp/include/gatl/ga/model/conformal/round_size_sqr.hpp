...
#ifndef __GA_MODEL_CONFORMAL_ROUND_SIZE_SQR_HPP__
#define __GA_MODEL_CONFORMAL_ROUND_SIZE_SQR_HPP__

namespace ga {

    // Returns the squared size parameter of a given dual round.
    template<typename CoefficientType, typename Expression, ndims_t D>
    constexpr decltype(auto) dual_round_size_sqr(clifford_expression<CoefficientType, Expression> const &dual_round, conformal_metric_space<D> const &mtr) {
    ...
    template<typename CoefficientType, typename Expression, ndims_t D>
    constexpr decltype(auto) primal_round_size_sqr(clifford_expression<CoefficientType, Expression> const &primal_round, conformal_metric_space<D> const &mtr) {
...
#endif // __GA_MODEL_CONFORMAL_ROUND_SIZE_SQR_HPP__
