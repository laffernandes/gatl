...
#ifndef __GA_MODEL_CONFORMAL_EUCLIDEAN_VECTOR_HPP__
#define __GA_MODEL_CONFORMAL_EUCLIDEAN_VECTOR_HPP__
...
namespace ga {
    ...
    constexpr decltype(auto) euclidean_vector(conformal_metric_space<D> const &mtr, Types &&... coords) GA_NOEXCEPT {
    ...
    constexpr decltype(auto) euclidean_vector(conformal_metric_space<D> const &mtr, IteratorType begin, IteratorType end) GA_NOEXCEPT {
...
#endif // __GA_MODEL_CONFORMAL_EUCLIDEAN_VECTOR_HPP__
