...
namespace ga {
    ...
    constexpr decltype(auto) flat_direction(clifford_expression<CoefficientType, Expression> const &flat, conformal_metric_space<D> const &mtr) {
        return lcont(-e(c<D + 2>), flat, mtr);
    }
