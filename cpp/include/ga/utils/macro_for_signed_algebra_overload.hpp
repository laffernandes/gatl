#ifndef __GA_UTILS_MACRO_FOR_SIGNED_ALGEBRA_OVERLOAD_HPP__
#define __GA_UTILS_MACRO_FOR_SIGNED_ALGEBRA_OVERLOAD_HPP__
...
#endif // __GA_UTILS_MACRO_FOR_SIGNED_ALGEBRA_OVERLOAD_HPP__
