...
namespace ga {
	...
	template<class DirectionCoefficientType, class DirectionExpression, class FlatCoefficientType, class FlatExpresion, ndims_t N>
	constexpr decltype(auto) translate(clifford_expression<DirectionCoefficientType, DirectionExpression> const &direction, clifford_expression<FlatCoefficientType, FlatExpresion> const &flat, homogeneous_metric_space<N> const &mtr) {
