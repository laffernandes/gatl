#ifndef __GA_UTILS_CONFORMAL_MACRO_FOR_ALGEBRA_OVERLOAD_HPP__
#define __GA_UTILS_CONFORMAL_MACRO_FOR_ALGEBRA_OVERLOAD_HPP__

#define _GA_UTILS_CONFORMAL_ALGEBRA_OVERLOAD(SPACE) \
...
#endif // __GA_UTILS_CONFORMAL_MACRO_FOR_ALGEBRA_OVERLOAD_HPP__
