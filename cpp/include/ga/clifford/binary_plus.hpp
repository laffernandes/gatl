...
namespace ga {
	...
	namespace clifford {
		...
		namespace detail {
			...
			constexpr decltype(auto) binary_plus(clifford_expression<LeftElementType, LeftOtherElementTypes...> const &lhs, clifford_expression<> const &rhs) {
				return insert(binary_plus(lhs.next(), rhs), lhs.element());
			}
			...
			constexpr decltype(auto) binary_plus(clifford_expression<> const &lhs, clifford_expression<RightElementType, RightOtherElementTypes...> const &rhs) {
				return insert(binary_plus(lhs, rhs.next()), rhs.element());
			}
