#ifndef __GA_CLIFFORD_MACRO_FOR_ALGEBRA_OVERLOAD_HPP__
#define __GA_CLIFFORD_MACRO_FOR_ALGEBRA_OVERLOAD_HPP__
...
#endif // __GA_CLIFFORD_MACRO_FOR_ALGEBRA_OVERLOAD_HPP__
