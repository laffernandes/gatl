#ifndef __GA_CLIFFORD_BINARY_MINUS_ELEMENT_HPP__
#define __GA_CLIFFORD_BINARY_MINUS_ELEMENT_HPP__
	...
	namespace clifford {
		...
		namespace detail {
			...
			constexpr decltype(auto) binary_minus_element(components<LeftCoefficientType, PossibleGrades> const &lhs, component<RightCoefficientType, dbasis_blade<PossibleGrades> > const &rhs) {
				//TODO lazy
				typedef typename std::common_type<LeftCoefficientType, decltype(-RightCoefficientType()), decltype(LeftCoefficientType() - RightCoefficientType())>::type coefficient_t;
...
#endif // __GA_CLIFFORD_BINARY_MINUS_ELEMENT_HPP__
