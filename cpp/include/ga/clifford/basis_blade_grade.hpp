#ifndef __GA_CLIFFORD_BASIS_BLADE_GRADE_HPP__
#define __GA_CLIFFORD_BASIS_BLADE_GRADE_HPP__
	...
	namespace clifford {
		...
		namespace detail {
			...
			constexpr grade_t basis_blade_grade(dbasis_blade<PossibleGrades> const &arg) {
				return static_cast<grade_t>(ones(arg.get()));
			}
...
#endif // __GA_CLIFFORD_BASIS_BLADE_GRADE_HPP__
