...
namespace ga {
	...
	namespace clifford {
		...
		namespace detail {
			...
			struct _orthogonal_graded_product_component_eval {
				...
				constexpr static decltype(auto) bind(component<LeftCoefficientType, cbasis_blade<LeftBasisBlade> > const &lhs, component<RightCoefficientType, cbasis_blade<RightBasisBlade> > const &rhs, metric_space<orthogonal_metric_space<OrthogonalMetricSpaceType> > const &, KeepIfGradesFunc const &) {
			...
			constexpr decltype(auto) graded_product_element(component<LeftCoefficientType, LeftBasisBladeType> const &lhs, component<RightCoefficientType, RightBasisBlade> const &rhs, metric_space<orthogonal_metric_space<OrthogonalMetricSpaceType> > const &mtr, KeepIfGradesFunc const &keep) {
				return make_simple_clifford_expression(_orthogonal_graded_product_component_maybe_eval<KeepIfGradesFunc::template possible_grades<LeftBasisBladeType::possible_grades(), RightBasisBlade::possible_grades(), OrthogonalMetricSpaceType::vector_space_dimension()>::value>::bind(lhs, rhs, mtr, keep));
			}
