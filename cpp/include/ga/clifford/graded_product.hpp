...
namespace ga {
	...
	namespace clifford {
		...
		namespace detail {
			...
			constexpr empty_expression_tree graded_product_inner_loop(LeftItrType const &, itr_end const &, metric_space<MetricSpaceType> const &, KeepIfGradesFunc const &) {
			...
			constexpr empty_expression_tree graded_product(itr_end const &, RightItrType const &, metric_space<MetricSpaceType> const &, KeepIfGradesFunc const &) {
				return empty_expression_tree();
			}

			template<class LeftItrType, class MetricSpaceType, class KeepIfGradesFunc>
			constexpr empty_expression_tree graded_product(LeftItrType const &, itr_end const &, metric_space<MetricSpaceType> const &, KeepIfGradesFunc const &) {
				return empty_expression_tree();
			}

			template<class MetricSpaceType, class KeepIfGradesFunc>
			constexpr empty_expression_tree graded_product(itr_end const &, itr_end const &, metric_space<MetricSpaceType> const &, KeepIfGradesFunc const &) {
				return empty_expression_tree();
			}
