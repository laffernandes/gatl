...
#ifndef __GA_CORE_EXPRESSION_PRODUCT_COMPONENTS_HPP__
#define __GA_CORE_EXPRESSION_PRODUCT_COMPONENTS_HPP__
...
#endif // __GA_CORE_EXPRESSION_PRODUCT_COMPONENTS_HPP__
