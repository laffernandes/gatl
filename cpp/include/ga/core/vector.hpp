...
namespace ga {
	...
	namespace detail {
		...
		template<ndims_t N, class... CoordinatesTypes>
		struct deduce_vector;

		template<ndims_t N, class... CoordinatesTypes>
		using deduce_vector_t = typename deduce_vector<N, CoordinatesTypes...>::type;

		template<ndims_t N, class CoordinateType, class... NextCoordinateTypes>
		...
		template<ndims_t N, class CoordinateType>
		...
		template<ndims_t N, class CoefficientType, class Coefficient, class... NextCoordinateTypes>
		...
		template<ndims_t N, class CoefficientType, class Coefficient>
		...
		template<ndims_t N, class CoefficientType, class Expression, class... NextCoordinateTypes>
		...
		template<ndims_t N, class CoefficientType, class Expression>
		...
		struct make_vector_sequential_storage_simple {
			template<class... CoordinatesTypes>
		...
		private:
			...
			template<class ValueType, std::size_t Size, std::size_t... Indices>
			...
			template<class CoordinateType, class... NextCoordinatesTypes>
			...
			template<class CoefficientType, class Expression, class... NextCoordinatesTypes>
			...
			template<class... ValueTypes, std::size_t... Indices>
		...
		template<class CliffordExpression, class Enabled = void>
		struct make_vector {
			template<class... CoordinatesTypes>
		...
		template<class CliffordExpression>
	...
	template<class MetricSpaceType, class... CoordinatesTypes>
