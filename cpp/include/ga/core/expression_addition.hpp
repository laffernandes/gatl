...
namespace ga {
	...
	namespace detail {
		...
		template<typename LeftCoefficient, default_integral_t LeftBasisVectors, typename RightCoefficient, bitset_t RightPossibleGrades, typename RightBitset>
		...
		template<typename LeftCoefficient, bitset_t LeftPossibleGrades, typename LeftBitset, typename RightCoefficient, default_integral_t RightBasisVectors>
		...
		template<typename LeftCoefficient, bitset_t LeftPossibleGrades, typename LeftBitset, typename RightCoefficient, bitset_t RightPossibleGrades, typename RightBitset>
