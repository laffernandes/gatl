...
namespace ga {
	...
	namespace detail {
		...
		public:
			...
			struct are_valid_grades {
				using type = equal_t<addition_t<RightGrade, product_t<constant_value<-1>, LeftGrade, value_mapping> >, ResultGrade>;
			};
	...
	constexpr decltype(auto) lcont(clifford_expression<LeftCoefficientType, LeftExpression> const &lhs, clifford_expression<RightCoefficientType, RightExpression> const &rhs, metric_space<MetricSpaceType> const &mtr) noexcept {
	...
	constexpr decltype(auto) lcont(scalar_clifford_expression<LeftCoefficientType, LeftCoefficient> const &lhs, clifford_expression<RightCoefficientType, RightExpression> const &rhs) noexcept {
	...
	constexpr decltype(auto) lcont(clifford_expression<LeftCoefficientType, LeftExpression> const &lhs, scalar_clifford_expression<RightCoefficientType, RightCoefficient> const &rhs) noexcept {
		return lcont(lhs, rhs, detail::real_metric_space());
	}

	template<typename LeftCoefficientType, typename LeftCoefficient, typename RightCoefficientType, typename RightCoefficient>
	constexpr decltype(auto) lcont(scalar_clifford_expression<LeftCoefficientType, LeftCoefficient> const &lhs, scalar_clifford_expression<RightCoefficientType, RightCoefficient> const &rhs) noexcept {
		return lcont(lhs, rhs, detail::real_metric_space());
	}
	...
	constexpr decltype(auto) lcont(clifford_expression<LeftCoefficientType, LeftExpression> const &lhs, RightType const &rhs, metric_space<MetricSpaceType> const &) noexcept {
	...
	constexpr decltype(auto) lcont(clifford_expression<LeftCoefficientType, LeftExpression> const &lhs, RightType const &rhs) noexcept {
		return lcont(lhs, scalar(rhs), detail::real_metric_space());
	}
	...
	constexpr decltype(auto) lcont(LeftType const &lhs, clifford_expression<RightCoefficientType, RightExpression> const &rhs, metric_space<MetricSpaceType> const &) noexcept {
	...
	constexpr decltype(auto) lcont(LeftType const &lhs, clifford_expression<RightCoefficientType, RightExpression> const &rhs) noexcept {
		return lcont(scalar(lhs), rhs, detail::real_metric_space());
	}
	...
	constexpr decltype(auto) lcont(LeftType const &lhs, RightType const &rhs, metric_space<MetricSpaceType> const &) noexcept {
	...
	constexpr decltype(auto) lcont(LeftType const &lhs, RightType const &rhs) noexcept {
		return lcont(scalar(lhs), scalar(rhs), detail::real_metric_space());
	}
