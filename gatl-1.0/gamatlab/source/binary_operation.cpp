...
mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	if (nelems1 == nelems2)
	{
		...
		for (i=0; i<nelems1; ++i)
		{
			...
			to_matlab( result, i, OPERATION( to_multivector( arg1, i ), to_multivector( arg2, i ) ) );
	...
	if (nelems2 == 1)
	{
		...
		{
			OMP_LOOP_EXCEPTION_HANDLING_BEGIN
			to_matlab( result, i, OPERATION( to_multivector( arg1, i ), m2 ) );
			OMP_LOOP_EXCEPTION_HANDLING_END
		}
	}
	...
	if (nelems1 == 1)
	{
		...
		{
			OMP_LOOP_EXCEPTION_HANDLING_BEGIN
			to_matlab( result, i, OPERATION( m1, to_multivector( arg2, i ) ) );
			OMP_LOOP_EXCEPTION_HANDLING_END
		}
	}
