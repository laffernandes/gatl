...
if isscalar(m) || (dim > n)
    ...
    operation = str2func([model_name '_gp_em']);
    try
        ...
        switch err.identifier
            case 'MATLAB:UndefinedFunction'
                error('GAToolbox:UndefinedFunction','Geometric algebra model ''%s'' does not implement ''gp_em'' or it was not compiled.',model_name)
            otherwise
                rethrow(err);
        end
    end
