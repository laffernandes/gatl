...
#ifndef _GRID_WARPED_BUFFER_
#define _GRID_WARPED_BUFFER_
...
/*******************************************************************************************************
 * grid::warped_buffer<coordinates_type,dimensions,sequence_container,warper,default_rounding_policy> class definition.
 *******************************************************************************************************/

// A memory buffer defined a warped discretization of an n-dimensional cartesian space.
template<typename coordinates_type, size_t dimensions, typename sequence_container, typename warper = linear_warper, typename default_rounding_policy = policy_round>
class warped_buffer : private buffer<dimensions,sequence_container>
{
private:
...
public:
	...
	// Copy constructor.
	warped_buffer(const warped_buffer<coord_type,dimensions,sequence_container> &other) : buffer( other )
	{
	...
	// Resize constructor.
	warped_buffer(const coord_array &lower_bounds, const coord_array &upper_bounds) : buffer()
	{
...
public:
	...
	{
		return warper::buffer_to_cartesian( buffer_position, m_lower_bounds, m_upper_bounds, buffer::size() );
	}
	...
	{
		return warper::template cartesian_to_buffer<rounding_policy>( cartesian_position, m_lower_bounds, m_upper_bounds, buffer::size() );
	}
...
public:
	...
	inline
	warped_buffer<coord_type,dimensions,sequence_container>& operator = (const warped_buffer<coord_type,dimensions,sequence_container> &other)
	{
